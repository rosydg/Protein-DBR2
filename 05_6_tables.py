...
def insert_in_CSV(amino,db):
	f= open("random_6_forest_"+ amino+".csv", 'wt')
	
	try:
		count_amino = 0
		t0 = time.time()
		csv_writer = csv.writer(f, delimiter=';', quotechar='"', quoting=csv.QUOTE_MINIMAL)
		csv_writer.writerow(['Vol-6', 'Vol-5', 'Vol-4','Vol-3', 'Vol-2', 'Vol-1', 'Vol1', 'Vol2', 'Vol3','Vol4', 'Vol5', 'Vol6', 'Fun-6', 'Fun-5', 'Fun-4','Fun-3','Fun-2','Fun-1', 'Fun1', 'Fun2', 'Fun3','Fun4', 'Fun5', 'Fun6','Chem-6', 'Chem-5', 'Chem-4','Chem-3', 'Chem-2', 'Chem-1','Chem1', 'Chem2', 'Chem3','Chem4', 'Chem5', 'Chem6','Hydro-6', 'Hydro-5','Hydro-4','Hydro-3', 'Hydro-2', 'Hydro-1','Hydro1','Hydro2','Hydro3', 'Hydro4','Hydro5','Hydro6','Pos_rel', 'C1_Q1','C1_Q2','C2_Q1', 'C2_Q2', 'T_Q1', 'T_Q2', 'Vol0'])
		...
		for i in list_amino:
			...
			if (i[3]>= pos_in + 6  and i[3]<= pos_fin-6):
			...
			csv_writer.writerow([list_occ[0], list_occ[1], list_occ[2], list_occ[3], list_occ[4], list_occ[5],list_occ[6], list_occ[7], list_occ[8], list_occ[9], list_occ[10], list_occ[11],list_func[0], list_func[1], list_func[2], list_func[3], list_func[4], list_func[5],list_func[6], list_func[7], list_func[8], list_func[9], list_func[10], list_func[11],list_chem[0], list_chem[1], list_chem[2], list_chem[3], list_chem[4], list_chem[5],list_chem[6], list_chem[7], list_chem[8], list_chem[9], list_chem[10], list_chem[11],list_hydro[0], list_hydro[1], list_hydro[2], list_hydro[3], list_hydro[4], list_hydro[5],list_hydro[6], list_hydro[7], list_hydro[8], list_hydro[9], list_hydro[10], list_hydro[11], pos_relativa, normc1[0], normc1[1], normc2[0], normc2[1], normtors[0],normtors[1], vol])	
