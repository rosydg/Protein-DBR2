...
# Tale script crea una tabella in un file csv con colonne:
# VOLUME-3 VOLUME -2 VOLUME -1 VOLUME 1 VOLUME 2 VOLUME3 
# FUNC-3 FUNC-2 FUNC-1 FUNC1 FUNC2 FUNC-3
# CHEMICAL-3 CHEMICAL-2 CHEMICAL-1 CHEMICAL1 CHEMICAL2 CHEMICAL3
# HYDRO-3 HYDRO-2 HYDRO-1 HYDRO1 HYDRO2 HYDRO3
# POSIZIONE_RELATIVA
# NORMA CURVATURA1 QUATERNA IN CUI L'AMMINOACIDO E' IN QUARTA POSIZIONE
# NORMA CURVATURA1 QUATERNA IN CUI L'AMMINOACIDO E' IN PRIMA POSIZIONE
# NORMA CURVATURA2 QUATERNA IN CUI L'AMMINOACIDO E' IN QUARTA POSIZIONE
# NORMA CURVATURA2 QUATERNA IN CUI L'AMMINOACIDO E' IN PRIMA POSIZIONE
# NORMA TORSIONE QUATERNA IN CUI L'AMMINOACIDO E' IN QUARTA POSIZIONE
# NORMA TORSIONE QUATERNA IN CUI L'AMMINOACIDO E' IN PRIMA POSIZIONE
# VOLUME AMMINOACIDO PIÙ RIPETUTO IN CIASCUNA POS

def insert_in_CSV(db):
	f= open("random_3_forest_"+sys.argv[1]+".csv", 'wt')
	...
	try:
		...
		for i in list_amino:
			...
			if (count_amino == 100):
				t1 = time.time()
				print("100 "+str(amino)+" processed in... "+ str(t1 - t) + " sec")
				count_amino = 0
				t = time.time()
