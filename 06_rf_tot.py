...
def random_forest(csvfilename):
	...
	export_graphviz(regressor.estimators_[ind], out_file = "tree_tot.dot",feature_names = features, rounded = True, proportion = 2, filled = True)
	call(["dot", "-Tsvg", "tree_tot.dot", "-o", "tree_tot.svg", "-v"])'''
