...
def insert_in_CSV(amino,db):
	...
	try:
		...
		for i in list_amino:
			...
			if (count_amino == 200):
				t1 = time.time()
				print("200 "+str(amino)+" processed in... "+ str(t1 - t) + " sec")
				count_amino = 0
				t = time.time()
			...
			if (i[3]>= pos_in + 9  and i[3]<= pos_fin-9):
				...
				csv_writer.writerow([list_occ[0], list_occ[1], list_occ[2], list_occ[3], list_occ[4], list_occ[5],list_occ[6], list_occ[7], list_occ[8], list_occ[9], list_occ[10], list_occ[11],list_occ[12],list_occ[13], list_occ[14], list_occ[15], list_occ[16],list_occ[17], list_func[0], list_func[1], list_func[2], list_func[3], list_func[4], list_func[5],list_func[6], list_func[7], list_func[8], list_func[9], list_func[10], list_func[11],list_func[12], list_func[13], list_func[14], list_func[15],list_func[16], list_func[17],list_chem[0], list_chem[1], list_chem[2], list_chem[3], list_chem[4], list_chem[5],list_chem[6], list_chem[7], list_chem[8], list_chem[9], list_chem[10], list_chem[11],list_chem[12], list_chem[13], list_chem[14], list_chem[15],list_chem[16], list_chem[17], list_hydro[0], list_hydro[1], list_hydro[2], list_hydro[3], list_hydro[4], list_hydro[5],list_hydro[6], list_hydro[7], list_hydro[8], list_hydro[9], list_hydro[10], list_hydro[11],list_hydro[12], list_hydro[13], list_hydro[14], list_hydro[15],list_hydro[16], list_hydro[17], pos_relativa, normc1[0], normc1[1], normc2[0], normc2[1], normtors[0],normtors[1], vol])	
